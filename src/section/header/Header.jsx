    ...
    <>
      <HeaderWrapper>
        <ContentWrapper>
          ...
          <h1>Web Developer</h1>
          <p>I am a skilled and driven web developer with a strong foundation in <strong> JavaScript, HTML, CSS and TypeScript</strong> along with extensive experience working with React. I specialize in building modern, responsive, and user-friendly web applications with a keen eye for both functionality and design.
            In addition to my technical expertise, I bring strong skill in <strong>transformational leadership</strong> and <strong>project management</strong>, allowing me to effectively guide teams, foster growth, and drive development processes from idea to delivery. I am passionate about <strong>problem-solving</strong> and thrive in fast-paced environments where creativity and structured execution are essential.</p>
          <IconWrapper>
            <IconRow />
          </IconWrapper>
        </ContentWrapper>
